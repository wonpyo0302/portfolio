	...
	<div class="sub">
		<div class="size">
			...
			<h6 class="sub_content" style="text-align: left">
				<img src="/hotel/image/boardPic/qna.png" width="40px"> 게스트 전용
				문의사항 게시판입니다.
			</h6>
			<br> <br> <br> <br>
			<div class="bbs">
				<form method="get" name="frm" id="frm" action="view.do"
					...
					<table class="board_write">
						<div class="title">
							<tr>
								...
								<td  name="gboard_type" style="text-align: left"><c:if
						...
						<tr>
							...
							<td colspan='2' class="date" style="width: 30%"><fmt:formatDate
									value="${data.gboard_updatedate}" pattern="yyyy/MM/dd hh:mm:ss" /></td>
						</tr>
						<tr>
							<th>작성자</th>
					...
					<div class="btnSet" style="text-align: right;">
						<a href="edit.do?gboard_no=${data.gboard_no}" class="btn">수정</a> <a
							...
							href="javascript:goList();" class="btn" style="text-align: right">목록
						</a>
					</div>
