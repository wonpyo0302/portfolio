                    ...
                    <table class="board_write">
                        <tbody>
							<tr>
								...
								<th>등록일자</th>
								<td><td class="date" style="width:150px""> <fmt:formatDatevalue="${data.gnotice_regdate}" pattern="yyyy-MM-dd hh:mm:ss"/></td></td>
							</tr>
							<tr>
								<th>작성자</th>
								<td>관리자</td>
								<th>수정일자</th>
								<td><td class="date" style="width:150px""> <fmt:formatDate value="${data.gnotice_regdate}" pattern="yyyy-MM-dd hh:mm:ss"/></td></td>
							</tr>
							<tr>
								<th>내용</th>
