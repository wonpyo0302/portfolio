...
public interface HostBoardService {
	...
	boolean insert(HostBoardVO vo); // 등록(관리자용)
	HostBoardVO edit(int hboard_no); // 수정폼(관리자용)
	boolean update(HostBoardVO vo); // 수정처리(관리자용)
	boolean delete(int hboard_no); // 삭제(관리자용)
